...
- Changing a session's assigned process blueprint should append a provider-visible system message so the agent sees the new expectation contract without relying on hidden metadata.
