...
- Agent Chat UI request authorization now reads dashboard session state through a shared dashboard-session-ui helper instead of keeping feature-local session-storage plumbing in the screen file
