...
const AgentGraphDocument = define.document("AgentGraphDocument", {
  role: "authoritative system memory for humans and llms",
});

AgentGraphDocument.organizes(`
- Purpose: state what Agentish is for.
- Authority: define how truth weight and human authority work.
- Corpus: define the document as one global semantic graph.
- Refinement: define how the graph is iteratively improved.
- Analysis: define what graph analysis should judge.
- Open Questions: preserve unresolved design questions explicitly.
`);
