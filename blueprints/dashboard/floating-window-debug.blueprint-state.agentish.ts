...
- current verification focus also includes scaled height accounting because zoomed windows previously kept unscaled vertical scroll length even when width fit math was correct
`);
