...
- Projects UI request authorization now reads dashboard session state through a shared dashboard-plugin helper instead of keeping feature-local session-storage plumbing in the screen file
