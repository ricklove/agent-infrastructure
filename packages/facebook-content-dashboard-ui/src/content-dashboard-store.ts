    ...
    return [
      {
        id: `gen-${timestamp}-1`,
        sourceId: source.id,
        title: `[MOCK ${runTag}] ${source.pattern} · Community support`,
        format: "image",
        stage: "draft",
        positioning: "Supportive, civic, family-safe",
        captionPreview: `[MOCK TEXT VARIANT 1 · ${runTag}] Rebuilt from "${source.title}" into a community-support message. ${source.adaptationRule}`,
        ...
        previewMediaPath: buildMockImagePreview(source, "Mock community-support image treatment ${runTag}", 0, timestamp),
      ...
      },
      {
        id: `gen-${timestamp}-2`,
        sourceId: source.id,
        title: `[MOCK ${runTag}] ${source.angle} · Gratitude statement`,
        format: "quote",
        stage: "draft",
        positioning: "Short gratitude-led statement",
        captionPreview: `[MOCK TEXT VARIANT 2 · ${runTag}] ${source.hook.toUpperCase()} THANK YOU TO THE PEOPLE WHO KEEP SHOWING UP.`,
        ...
        previewMediaPath: buildMockImagePreview(source, "Mock gratitude-led image treatment ${runTag}", 1, timestamp),
        textProvider: provider,
        imageProvider: provider === "mock" ? "mock" : "seed",
        generatedKind: "generated",
      },
      {
        id: `gen-${timestamp}-3`,
        sourceId: source.id,
        title: `[MOCK ${runTag}] ${source.sourcePage} · Story-led perspective`,
        format: "story",
        stage: "draft",
        positioning: "Empathy and public-service framing",
        captionPreview: `[MOCK TEXT VARIANT 3 · ${runTag}] ${source.whyItWorked} This draft deliberately reframes "${source.title}" into a more protective and story-led post for your page.`,
        ...
        previewMediaPath: buildMockImagePreview(source, "Mock story-led image treatment ${runTag}", 2, timestamp),
        textProvider: provider,
        imageProvider: provider === "mock" ? "mock" : "seed",
        generatedKind: "generated",
      },
