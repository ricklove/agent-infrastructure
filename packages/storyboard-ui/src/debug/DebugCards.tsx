...
export function DebugImageCard({
  ...
  return (
    <a
      className="group flex items-start gap-3 rounded border border-white/10 bg-zinc-950/90 p-3 transition hover:border-cyan-300/60"
      href={href}
    >
      <div
        className="flex items-center justify-center overflow-hidden rounded border border-white/10 bg-black"
